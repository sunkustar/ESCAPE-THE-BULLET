...
count=-1
blist=[0,1,2]
bul=[[0,0,1,1,v1],[0,0,1,1,v1],[0,0,1,1,v1]]
width = 960
height = 540
...
class idcard(gym.Env):
    def __init__(self):
        ...
        self.observation_space = spaces.MultiDiscrete([961, 541, 961, 541, 961, 541, 961, 541])
    ...
    def reset(self,seed=None):
        ...
        self.observation=np.array([np.random.randint(100, 900),np.random.randint(100, 540),0,0,0,0,0,0])
